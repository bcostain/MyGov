...
officialFirstName= word(d,1)
officialLastName=word(d,-1)
#
# CREATE MASTER DATE FRAME FOR CONTACTS
master = data.frame(officialFirstName, officialLastName, officeName, f,ph2,circle,photo,officialInd,officeInd)
colnames(master) <- c("First Name","Last Name","Organization", "Email","phone","Circle","Photo","officialInd","officeInd")
